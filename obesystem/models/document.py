...
class ObesystemDocument(models.Model):
    _name = 'obesystem.document'
    ...
    state = fields.Selection([
        ...
        ('published', 'Published'),
    ], default='unpublished', string='Status', tracking=True)

    attachment_ids = fields.Many2many(
        'ir.attachment', 'obesystem_document_ir_attachment_rel', 'document_id', 'attachment_id',
        string='Files'
    )
